...
class Program
{
    static void Main(string[] args)
    {
        ...
        Console.WriteLine($"Tổng các ước số thực sự của {n}: {sum}");

        // b)
        bool isPerfect = sum == n;
        Console.WriteLine($"{n} có phải là số hoàn hảo không: {isPerfect}");
        ...
        Console.WriteLine($"Số lượng ước số lẻ của {n}: {countOddDivisors}");
